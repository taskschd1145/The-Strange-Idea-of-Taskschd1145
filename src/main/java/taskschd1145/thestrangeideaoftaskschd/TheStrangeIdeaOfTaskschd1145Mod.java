...
@Mod("the_strange_idea_of_taskschd1145")
public class TheStrangeIdeaOfTaskschd1145Mod {
	public static final Logger LOGGER = LogManager.getLogger(TheStrangeIdeaOfTaskschd1145Mod.class);
	public static final String MODID = "the_strange_idea_of_taskschd1145";

	public TheStrangeIdeaOfTaskschd1145Mod(IEventBus modEventBus) {
