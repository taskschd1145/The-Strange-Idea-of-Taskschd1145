...
public class TheStrangeIdeaOfTaskschd1145ModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(Registries.ENTITY_TYPE, TheStrangeIdeaOfTaskschd1145Mod.MODID);
